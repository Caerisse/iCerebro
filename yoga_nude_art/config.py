...
do_like_percentage = 90
do_follow_percentage = 80
do_follow_times = 3
do_story_percentage = 80
user_interact_percentage = 70
...
# Posts sources
# https://www.instagram.com/flocke_art/
source = 'flocke_art'

# variables
similar_accounts = [
    'yoga', 'yoga_girl', 'merins_yoga_wanderlust', 'almudena_yogalife', 'aloyoga',
    'simya_evi', 'nude_yogagirl', 'nuda.sisters', 'sensualyoga_', 'natural_bums',
    'stretchylicious', 'ethereal_yogagirl', 
]
friend_list = []
ignored_users = []
